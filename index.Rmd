...
En 3 casos (uno de PyP, y dos de Captura Consulting), se utilizó un estimado de votos por otros candidatos (dado que los mismos no fueron publicados), para estimar el voto válido, de acuerdo a cada encuesta.<br>
<br>
<br>

<b><h3>Sobre resultados **sin** ponderaciones</h3></b>

Debido a que las encuestadoras han preguntado a votantes acerca de su intención de voto por 16 candidatos distintos (durante el periodo analizado), incluir líneas individuales para cada uno de ellos dificultaría la claridad en la representación gráfica de tendencias, por lo cual las visualizaciones incluyen únicamente datos para las tres postulaciones con mayor intención de voto. Si gusta consultar la base de datos con los resultados desagregados, incluyendo al resto de los candidatos, puede hacerlo en el siguiente enlace.
...
Algunas encuestas no reportan datos sobre el “voto no declarado”. En este caso se dejó en blanco la información para mostrar la ausencia.
